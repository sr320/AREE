...
covered by current-version CI; the Bismark/methylKit raw path is not.** It did
...
real DSL2 wiring and tool commands, but no bisulfite FASTQ fixture or real raw
study has exercised them.
